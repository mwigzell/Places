...
public class HttpUtilsTest {
    ...
    public void testDumpUrlPlaces() throws Exception {
        String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-33.8670522,151.1957362&radius=500&types=food&name=harbour&key=AIzaSyCfiVBYgyTtCJUKziOBx7H367ovTkpr6JE";
        utils.dumpUrl(url);
        Thread.sleep(5000);
    }
